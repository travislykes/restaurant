...
{
    /**
     * @var \TravisLykes\HofExpressApp\Controller\AddressController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\TravisLykes\HofExpressApp\Controller\AddressController::class)
    ...
    public function listActionFetchesAllAddressesFromRepositoryAndAssignsThemToView()
    {
        ...
        $addressRepository = $this->getMockBuilder(\TravisLykes\HofExpressApp\Domain\Repository\AddressRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $address = new \TravisLykes\HofExpressApp\Domain\Model\Address();
