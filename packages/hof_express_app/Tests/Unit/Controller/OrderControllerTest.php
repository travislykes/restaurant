...
{
    /**
     * @var \TravisLykes\HofExpressApp\Controller\OrderController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\TravisLykes\HofExpressApp\Controller\OrderController::class)
    ...
    public function listActionFetchesAllOrdersFromRepositoryAndAssignsThemToView()
    {
        ...
        $orderRepository = $this->getMockBuilder(\TravisLykes\HofExpressApp\Domain\Repository\OrderRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $order = new \TravisLykes\HofExpressApp\Domain\Model\Order();
