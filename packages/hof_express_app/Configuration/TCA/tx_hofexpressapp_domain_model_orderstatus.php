...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderstatus',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'EXT:hof_express_app/Resources/Public/Icons/tx_hofexpressapp_domain_model_orderstatus.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'name' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderstatus.name',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'description' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderstatus.description',
            'config' => [
                'type' => 'text',
                'enableRichtext' => true,
