...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_deliverytype',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => 'name',
        'iconfile' => 'EXT:hof_express_app/Resources/Public/Icons/tx_hofexpressapp_domain_model_deliverytype.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'name' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_deliverytype.name',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
