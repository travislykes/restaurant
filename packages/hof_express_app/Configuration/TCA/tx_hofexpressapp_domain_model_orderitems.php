...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderitems',
        'label' => 'quantity',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => '',
        'iconfile' => 'EXT:hof_express_app/Resources/Public/Icons/tx_hofexpressapp_domain_model_orderitems.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'quantity' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderitems.quantity',
            'config' => [
                'type' => 'input',
                'size' => 4,
                'eval' => 'int,required'
        ...
        'food' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hof_express_app/Resources/Private/Language/locallang_db.xlf:tx_hofexpressapp_domain_model_orderitems.food',
            'config' => [
                'type' => 'select',
